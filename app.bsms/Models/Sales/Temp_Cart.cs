...
// Type: app.bsms.Models.Sales.Temp_Cart
...
namespace app.bsms.Models.Sales
{
  public class Temp_Cart
  {
    ...
    [Display(Name = "TokenNumber", ResourceType = typeof (Resources.Resources))]
    [StringLength(20)]
    ...
    [Required(ErrorMessageResourceName = "StaffCodeRequired", ErrorMessageResourceType = typeof (Resources.Resources))]
    [Display(Name = "StaffCode", ResourceType = typeof (Resources.Resources))]
    public string staffCode { get; set; }

    [Required(ErrorMessageResourceName = "StaffNameRequired", ErrorMessageResourceType = typeof (Resources.Resources))]
    ...
    public List<app.bsms.Models.Sales.Post.Payment_Details> payDetails { get; set; }
