...
// Type: app.bsms.Models.Manage.Customer.Register

 
 

using app.bsms.Models.Appointment;
...
namespace app.bsms.Models.Manage.Customer
{
  public class Register
  {
    ...
    [Display(Name = "ClassCode", ResourceType = typeof(Resources.Resources))]
    ...
    [Display(Name = "GenderCode", ResourceType = typeof(Resources.Resources))]
    ...
    [Display(Name = "NationalityCode", ResourceType = typeof(Resources.Resources))]
    ...
    public List<app.bsms.Models.General.ListItems> lstSalutation { get; set; }

    public List<app.bsms.Models.General.ListItems> lstCustomerClass { get; set; }

    public List<app.bsms.Models.General.ListItems> lstAgeGroup { get; set; }

    public List<app.bsms.Models.General.ListItems> lstCountry { get; set; }

    public List<app.bsms.Models.General.ListItems> lstState { get; set; }

    public List<app.bsms.Models.General.ListItems> lstTherapist { get; set; }

    public List<app.bsms.Models.General.ListItems> lstRace { get; set; }

    public List<app.bsms.Models.General.ListItems> lstSource { get; set; }

    public List<app.bsms.Models.General.ListItems> lstOccupation { get; set; }

    public List<app.bsms.Models.General.ListItems> lstConsultant { get; set; }

    public List<app.bsms.Models.General.ListItems> lstNationality { get; set; }

    public List<app.bsms.Models.General.ListItems> lstReligion { get; set; }

    public List<app.bsms.Models.General.ListItems> lstGender { get; set; }

    public List<app.bsms.Models.General.ListItems> lstCustomerType { get; set; }

    public List<app.bsms.Models.General.ListItems> lstcustomerGroup1 { get; set; }

    public List<app.bsms.Models.General.ListItems> lstcustomerGroup2 { get; set; }

    public List<app.bsms.Models.General.ListItems> lstcustomerGroup3 { get; set; }

    public List<app.bsms.Models.General.ListItems> lstLanguage { get; set; }

    public List<app.bsms.Models.General.ListItems> lstLocation { get; set; }

    public List<app.bsms.Models.General.ListItems> lstMaritalStatus { get; set; }

    public List<app.bsms.Models.General.ListItems> lstSkinType { get; set; }

    public List<app.bsms.Models.General.ListItems> lstSalaryRange { get; set; }

    public List<Supplimentary_Member> Supplimentary_Members { get; set; }
  }
}
